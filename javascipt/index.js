fetch("https://cors-anywhere.herokuapp.com/https://api.deezer.com/chart/")
    ...
    .then(function (data) {
        ...
        for (let i = 0; i < 5; i++) {
            canciones.innerHTML += '<article><img class="imagen" src="' + songs[i].album.cover_big + '" alt="' + songs[i].title + '"><h3 class="nombre_artista"><a href="detail-track.html">' + songs[i].title + '</a></h3></article>'
        }

        for (let i = 0; i < 5; i++) {
            albumes.innerHTML += '<article><img class="imagen" src="' + albums[i].tracks.cover_big + '" alt="' + albums[i].title + '"><h3 class="nombre_artista" id="bob"><a href="detail-artist.html">' + albums[i].title + '</a></h3></article>'
        }
